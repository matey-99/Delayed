...
Animation::Animation(const aiScene* scene, int index, Ref<SkeletalMesh> model)
...
void Animation::ReadMissingBones(const aiAnimation* animation, Ref<SkeletalMesh> model)
{
